                ...
                >
                    <div className="max-w-7xl mx-auto px-8 h-16 flex items-center justify-between">
                        ...
                        <Link href="/" className="flex items-center gap-3 group">
                            <AppLogoIcon className="w-6 h-6 fill-white opacity-90 group-hover:opacity-100 transition-opacity" />
                            <span className="text-sm tracking-[0.12em] font-medium text-white/80 group-hover:text-white transition-colors uppercase">
                                Vault
                            </span>
                        </Link>
                ...
                <footer className="border-t border-white/6 py-10">
                    <div className="max-w-7xl mx-auto px-8 flex flex-col md:flex-row items-center justify-between gap-4">
                        <div className="flex items-center gap-3">
                            <AppLogoIcon className="w-4 h-4 fill-white/30" />
                            <span className="text-[10px] tracking-[0.2em] text-white/20 uppercase">Vault</span>
                        </div>
